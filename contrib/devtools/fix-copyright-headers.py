...
// Copyright (c) 2009-2012 The Martkist Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Martkist/$1-%s The Martkist/' %s"
REGEX_CURRENT= re.compile("%s The Martkist" % year)
