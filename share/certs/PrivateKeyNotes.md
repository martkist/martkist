...
unlocked to sign the Martkist-Qt.app bundle.
...
allowing somebody to distribute a Martkist-Qt.app or martkist-qt-setup.exe with a valid
...
that the martkist-qt.exe file inside the installer had not been tampered with.
