...
#ifndef MARTKIST_CLIENTVERSION_H
#define MARTKIST_CLIENTVERSION_H
...
#define COPYRIGHT_STR "2009-" STRINGIZE(COPYRIGHT_YEAR) " The Martkist Core Developers, 2014-" STRINGIZE(COPYRIGHT_YEAR) " " COPYRIGHT_HOLDERS_FINAL

/**
 * martkistd-res.rc includes this file, but it cannot cope with real c++ code.
...
#include <vector>
 // MARTKIST
static const std::string MARTKIST_CLIENT_VERSION = MARTKIST_VERSION;
...
#endif // MARTKIST_CLIENTVERSION_H
