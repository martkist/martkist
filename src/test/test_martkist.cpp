...
#define BOOST_TEST_MODULE Martkist Test Suite

#include "test_martkist.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_martkist_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
