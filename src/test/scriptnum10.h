...
#ifndef MARTKIST_TEST_SCRIPTNUM10_H
#define MARTKIST_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Martkist Core 0.10.0, for cross-comparison.
 */
public:
