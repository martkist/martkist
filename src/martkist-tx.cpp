...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s martkist-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  martkist-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded martkist transaction") + "\n" +
              "  martkist-tx [options] -create [commands]   " + _("Create hex-encoded martkist transaction") + "\n" +
              "\n";
...
static void MutateTxAddOutPubKey(CMutableTransaction& tx, const std::string& strInput)
{
    ...
    CMartkistAddress addr(scriptPubKey);
    ...
    if (bScriptHash) {
        ...
        CMartkistAddress redeemScriptAddr(scriptPubKey);
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded martkist transaction
