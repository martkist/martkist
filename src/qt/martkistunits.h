...
#ifndef MARTKIST_QT_MARTKISTUNITS_H
#define MARTKIST_QT_MARTKISTUNITS_H
...
/** Martkist unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class MartkistUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit MartkistUnits(QObject *parent);

    /** Martkist units.
      @note Source: https://en.martkist.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        MARTK,
...
typedef MartkistUnits::Unit MartkistUnit;

#endif // MARTKIST_QT_MARTKISTUNITS_H
