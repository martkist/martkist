    ...
    platformStyle(_platformStyle)
{
    ...
    freechPage = new FreechPage(platformStyle);
...
void WalletView::setMartkistGUI(MartkistGUI *gui)
{
    if (gui)
    {
...
void WalletView::gotoFreechPage()
{
    setCurrentWidget(freechPage);
}
