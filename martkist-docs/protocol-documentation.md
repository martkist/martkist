...
This document describes the protocol extensions for all additional functionality build into the Martkist protocol. This doesn't include any of the Martkist protocol, which has been left intact in the Martkist project. For more information about the core protocol, please see https://en.martkist.it/w/index.php?title#Protocol_documentation&action#edit
...
Martkist Outpoint https://martkist.org/en/glossary/outpoint
...
Martkist Input https://martkist.org/en/glossary/input
...
Martkist Output https://martkist.org/en/glossary/output
...
Martkist Public Key https://martkist.org/en/glossary/public-key
...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | -------- |
| 41 | vin | [CTxIn](#ctxin) | The unspent output which is holding 18000 MARTK
| # | addr | [CService](#cservice) | IPv4 address of the masternode
| 33-65 | pubKeyCollateralAddress | [CPubKey](#cpubkey) | CPubKey of the main 18000 MARTK unspent output
...
| 10004 | 5 | INSTANTSEND_MAX_VALUE | Controls the max value for an InstantSend transaction (currently 2000 martkist)
| 10007 | 8 | MASTERNODE_PAYMENT_ENFORCEMENT | Requires masternodes to be paid by miners when blocks are processed
| 10008 | 9 | SUPERBLOCKS_ENABLED | Superblocks are enabled (the 10% comes to fund the martkist treasury)
...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | -------- |
| 41 | vin1 | [CTxIn](#ctxin) | The unspent output which is holding 18000 MARTK for masternode 1
| 41 | vin2 | [CTxIn](#ctxin) | The unspent output which is holding 18000 MARTK for masternode 2
