...
* martkist.conf: contains configuration settings for martkistd or martkist-qt
* martkistd.pid: stores the process id of martkistd while running
...
* debug.log: contains debug information and general logging generated by martkistd or martkist-qt
